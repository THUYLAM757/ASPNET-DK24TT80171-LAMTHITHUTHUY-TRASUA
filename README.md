...
NguoiDung: Quản lý tài khoản (Khách hàng & Admin).
SanPham: Thực đơn trà sữa và danh sách topping đi kèm.
DonHang: Hóa đơn chính (thông tin người nhận, địa chỉ giao hàng, trạng thái, tổng tiền).
ChiTietDonHang: Chi tiết từng ly trà sữa và kích cỡ đã chọn của đơn hàng.
ToppingDonHang: Các topping đi kèm riêng cho từng ly trà sữa trong chi tiết đơn hàng.
